<script lang="ts">
	...
	import { HomeIcon, ShoppingBagIcon, ShoppingCartIcon, TagIcon, XIcon } from '@lucide/svelte';
...
{#if cart.orders.length > 0}
	...
	<div class="mx-4 border-y py-4 pt-6">
		<DiscountComponent {discounts} />
	</div>
	<div class="mx-4 flex flex-col gap-4 pb-8">
...
{:else}
	<div class="items-cente flex h-[calc(100dvh-4rem)]">
